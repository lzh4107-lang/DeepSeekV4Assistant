...
import 'shared/widgets/deepseek_setup_gate.dart';
...
Future<void> _initDesktopWindow() async {
  ...
  try {
    ...
    await DesktopWindowController.instance.initializeAndShow(title: '');
  } catch (_) {
          ...
          return DynamicColorBuilder(
            builder: (lightDynamic, darkDynamic) {
              ...
              return MaterialApp(
                ...
                onGenerateTitle: (ctx) =>
                    AppLocalizations.of(ctx)!.aboutPageAppName,
                ...
                home: DeepSeekSetupGate(child: _selectHome()),
                builder: (ctx, child) {
                      ...
                      try {
                        final isDesktop =
                            ...
                            (defaultTargetPlatform == TargetPlatform.windows ||
                                ...
                                defaultTargetPlatform == TargetPlatform.linux);
                        if (!isDesktop) return;
                        await windowManager.setTitle(l10n.aboutPageAppName);
