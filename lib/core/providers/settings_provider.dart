...
class SettingsProvider extends ChangeNotifier {
  ...
  Future<void> _load() async {
    ...
    if (_providerConfigs.isEmpty) {
      // This distribution is DeepSeek-first. Other compatible providers remain
      // available in settings, but a fresh install is ready for V4 immediately.
      ensureProviderConfig('DeepSeek', defaultName: 'DeepSeek');
    }
    if (_currentModelProvider == null || _currentModelId == null) {
      final deepSeek = _providerConfigs['DeepSeek'];
