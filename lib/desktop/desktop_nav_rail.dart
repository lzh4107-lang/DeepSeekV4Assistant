...
class DesktopNavRail extends StatelessWidget {
  ...
  final int activeIndex; // 0=Chat, 1=Translate, 2=Storage, 3=Settings, 4=Douyin
  final bool globalSearchActive;
  final VoidCallback onTapChat;
  final VoidCallback onTapGlobalSearch;
  final VoidCallback? onTapDouyin;
  ...
  Widget build(BuildContext context) {
    ...
    final isDouyinActive = activeIndex == 4;
      ...
      child: Column(
        children: [
          ...
          if (onTapDouyin != null) ...[
            const SizedBox(height: 8),
            _CircleAction(
              tooltip: l10n.douyinSearchTitle,
              icon: lucide.Lucide.Video,
              onTap: onTapDouyin!,
              size: 40,
              iconSize: 18,
              iconColor: isDouyinActive ? cs.primary : null,
            ),
          ],
          const SizedBox(height: 8),
          _CircleAction(
